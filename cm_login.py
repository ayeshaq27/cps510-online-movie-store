...
def on_login(root, entry_empid, entry_password):
    ...
    try:
        ...
        # CONTENT_MANAGER: EMPLOYEE_ID | MOVIE_TO_CHANGE | PASSWORD | EMAIL
...
def cm_login_user():
    ...
    root = tk.Tk()
    root.title("Content Manager Login")
    root.geometry("320x200")

    tk.Label(root, text="Content Manager Login", font=("Arial", 12)).pack(pady=10)
...
if __name__ == "__main__":
    print("CM login result:", cm_login_user())
